# Platform hardening conformance

Checks host assessment, permissions, injected failures, repeated lifecycle behavior, and sanitized diagnostics.

Windows evidence is profile-specific. Native Linux, ARM64, and WSL each need independent qualification.
