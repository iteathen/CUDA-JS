...
export { assertCompilerPublicRecord, compileIdentity, linkIdentity, normalizeCompileOptions, normalizeCompileRequest, normalizeLinkOptions, normalizeLinkRequest, validateLtoCompatibility } from './src/contract.mjs';
