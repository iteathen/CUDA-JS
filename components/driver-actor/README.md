...
**Status:** Accepted F3W internal experimental component

This component turns the accepted Windows F2 bootstrap into a bounded asynchronous runtime owner. One Worker opens the canonical Windows CUDA Driver, selects device zero, creates one private context, owns all raw values in an opaque registry, and closes child resources before the library.
...
The governing contract is [`../../docs/specs/SPEC-0003-driver-actor-resource-lifecycle.md`](../../docs/specs/SPEC-0003-driver-actor-resource-lifecycle.md).
