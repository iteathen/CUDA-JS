...
test('compatibility and host inspection are immutable and reconcile the current public surface', () => {
  assert.equal(CUDA_JS_COMPATIBILITY.package.version, '0.1.0-alpha.6');
  ...
  assert.equal(CUDA_JS_COMPATIBILITY.capabilities.deviceJsFrontend, 'restricted-spec-0013-v1+spec-0022-atomic-observation-v1+spec-0014-publication-mailbox-v1');
