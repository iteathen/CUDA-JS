...
export { DEVICE_JS_DENSE_NUMERIC_ERF_LIBRARY_CONTRACT, DEVICE_JS_DENSE_NUMERIC_ERF_TANH_LIBRARY_CONTRACT, DEVICE_JS_DENSE_NUMERIC_LIBRARY_CONTRACT, DEVICE_JS_DENSE_NUMERIC_TANH_LIBRARY_CONTRACT, DEVICE_JS_ERF_LIBRARY_CONTRACT, DEVICE_JS_LIBRARY_CONTRACT, DEVICE_JS_TANH_LIBRARY_CONTRACT };
...
function libraryContractFor(contract) {
  ...
  if (contract === DEVICE_JS_TANH_CONTRACT) return DEVICE_JS_TANH_LIBRARY_CONTRACT;
