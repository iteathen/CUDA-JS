...
- [`ADR-0001-repository-boundary.md`](ADR-0001-repository-boundary.md) — CUDA-JS is an independent generic runtime repository; UMCGS is a public-contract consumer.
