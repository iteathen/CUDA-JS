...
|---|---|---|---|
| [`2026-08-10-master-plan.md`](2026-08-10-master-plan.md) | `docs/plans/2026-08-10-master-plan.md` | Mixed completed F0–F9 implementation history with stale future LTO/package assumptions. | Native/platform qualification, execution-capability, and compatible-pair continuation plans. |
| [`2026-08-10-focus-branch-map.json`](2026-08-10-focus-branch-map.json) | `docs/plans/2026-08-10-focus-branch-map.json` | Machine map still marked completed F5 as planned, LTO as future implementation, and old package identities. | `next_step.yaml` plus the active continuation plans. |
| [`2026-08-11-hardware-qualification-program.md`](2026-08-11-hardware-qualification-program.md) | `docs/plans/2026-08-11-hardware-qualification-program.md` | Initial registry/runner program exists; remaining work is additional exact-profile qualification. | `2026-08-12-native-and-platform-qualification-continuation.md`. |
