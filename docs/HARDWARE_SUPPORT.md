...
| concurrent-launch | planned | not implemented | **not qualified** | after:PR 116 integration | SPEC-0016 implements and exactly qualifies one pending opaque operation on one private stream; proposed SPEC-0018 owns bounded widening | [#40](https://github.com/iteathen/CUDA-JS/issues/40) |
