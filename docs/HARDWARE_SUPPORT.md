...
|---|---|---|---|---|---|---|
| multi-gpu | planned | not implemented | **not qualified** | after:SPEC 0017 and first compatible pair | SPEC-0017 is accepted and has a draft portable foundation; protected main still has one default-selected private context, no integrated public selector, and no multi-device coordinator | [#20](https://github.com/iteathen/CUDA-JS/issues/20) |
