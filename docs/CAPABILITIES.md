...
| Optional CUDA library adapters | `planned` | `implemented` | `qualified` | `active` | Accepted SPEC-0023 framework and SPEC-0029 cuBLASLt f32 row-major matmul child. Exact Windows CUDA 13.3/cuBLASLt 13.5.1 ABI, numerical, lifecycle, and cleanup profile only; no bundled provider, tensor semantics, Linux promotion, or performance claim. |
