...
- [`SPEC-0013-restricted-device-js.md`](SPEC-0013-restricted-device-js.md) — accepted restricted-JavaScript frontend and compact generic GPU helper contract that keeps maintained CUDA-specific source/lowering inside CUDA-JS.
