# EXP-014 historical evidence

**Status:** Informational

The following record preserves the experiment's original qualification history from [CUDA-JS revision d13699e](https://github.com/iteathen/CUDA-JS/blob/d13699e44dc0ea8e2a36c13e159556773aded83e/experiments/exp-014/README.md). Branch/run identities and proposed-state wording describe that history. Current authority is linked from [the README](README.md).
