...
| `runtime.device-js-parallel` | Trusted-source shared/local/warp/atomic/numeric Device-JS primitives | Accepted atomic and warp-32 SPEC-0022 children; other families proposal-only; prerequisite dtype/view contracts remain authoritative |
