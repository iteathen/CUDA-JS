...
| `conformance.hardware` | Exact-profile support registry, architecture coverage, qualification orchestration, evidence indexing/sanitization, and generated public hardware list | [`../conformance/hardware/`](../conformance/hardware/README.md) and [`../docs/HARDWARE_SUPPORT.md`](../docs/HARDWARE_SUPPORT.md) | Active; one accepted Windows x64 GPU profile, broader hardware/platform campaign open |
...
| `conformance` | Production synthetic/native/public-contract capsules and exact-profile hardware qualification | [`../conformance/`](../conformance/README.md) | F3 lifecycle through F8 package/public-facade accepted on Windows; hardware registry seeded from exact evidence; portable/readiness controls run in Linux CI |
