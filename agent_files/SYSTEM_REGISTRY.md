...
| `project.experiments` | Future decision experiments and claim limits; currently documentation only | [`../experiments/`](../experiments/README.md) | Planned; execution not authorized |
...
| `schemas` | Future generated facts, semantic overlays, Runtime IR and products | [`../schemas/`](../schemas/README.md) | Reserved; no implementation authorized |
| `conformance` | Future synthetic/native/public-contract capsules | [`../conformance/`](../conformance/README.md) | Reserved; no implementation authorized |
| `experiments` | Disposable future decision experiments | [`../experiments/`](../experiments/README.md) | Documentation only |
...
| `tools` | Future schema/code-generation and developer tools | [`../tools/`](../tools/README.md) | Reserved |
...
| `scripts` | Thin documentation/static-validation entry points | [`../scripts/`](../scripts/) | Active, documentation support only |
...
| `backend.node-ffi` | Private Node host-call substrate | Exact supported-profile qualification evidence |
