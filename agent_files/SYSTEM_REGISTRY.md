...
| `runtime.device-selection` | Sanitized opaque device enumeration/selection and selected-device target resolution | Accepted SPEC-0017 authorizes active portable/software integration; exact selected-device native evidence remains separate, and multi-device orchestration remains SPEC-0024 |
