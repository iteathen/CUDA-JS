...
| `benchmarks` | Reproducible mechanism/regression/performance-observation evidence with no product-support inference | [`../benchmarks/`](../benchmarks/README.md) | Active for issue #28 performance/thermal/bounded-soak profiles; other families remain reserved |
