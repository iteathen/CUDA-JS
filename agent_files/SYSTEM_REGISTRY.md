...
| `runtime.facade` | Safe package API, private resource capabilities, stable errors, optional compiler ownership, standalone Device-JS helper, known-incompatible preflight, unconfirmed testing operation, and aggregate close | [`../components/runtime-facade/`](../components/runtime-facade/README.md) | OS-neutral public contract; Windows testing alpha retained; Linux reference adapter/package work active; mock-only portable consumer entry |
