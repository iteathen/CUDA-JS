...
| `runtime.cuda-library-adapters` | Optional finite context-bound provider handles, plans, typed-view/workspace leases, and ordinary-operation submission | [`../components/cuda-library-adapters/`](../components/cuda-library-adapters/README.md) | Accepted SPEC-0023 framework with SPEC-0029 cuBLASLt f32 first profile; exact Windows profile qualified |
