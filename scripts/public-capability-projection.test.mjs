...
function fixture() {
  ...
  return {
    ...
    compatibility: {
      package: { name: 'cuda-js', version: '0.1.0-alpha.14' },
      capabilities: {
    ...
    documents: {
      ...
      packaging: 'cuda-js 0.1.0-alpha.14 SPEC-0020 SPEC-0021 SPEC-0023 SPEC-0027 SPEC-0028 SPEC-0029 SPEC-0030 separate future publish unit',
...
test('package, capability, interop, and status-dimension drift are independently rejected', () => {
  const cases = [
    (value) => { value.documents.readme = value.documents.readme.replace('0.1.0-alpha.14', '0.1.0-alpha.2'); },
