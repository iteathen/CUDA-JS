...
function fixture() {
  const common = '0.1.0-alpha.10 SPEC-0010 SPEC-0011 SPEC-0012 SPEC-0013 SPEC-0014 SPEC-0016 SPEC-0017 SPEC-0019 SPEC-0027 SPEC-0028 separate future publish unit compileDeviceProgram() compileDeviceLibrary() discoverCudaDevices() `u64`/`i32`/`f32` typed `lto-ir` one pending GPU operation `u64` `i32` `f32`';
  ...
  return {
    ...
    compatibility: {
      package: { name: 'cuda-js', version: '0.1.0-alpha.10' },
      capabilities: {
    ...
    documents: {
      ...
      packaging: 'cuda-js 0.1.0-alpha.10 SPEC-0021 SPEC-0027 SPEC-0028 separate future publish unit',
...
test('package, capability, interop, and status-dimension drift are independently rejected', () => {
  const cases = [
    (value) => { value.documents.readme = value.documents.readme.replace('0.1.0-alpha.10', '0.1.0-alpha.2'); },
