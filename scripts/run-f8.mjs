...
const unit = { args: ['--test',
  ...
  'components/device-js/test/bounded-source-policy.test.mjs',
  'components/device-js/test/strict-contract.test.mjs',
  'components/device-js/test/device-library.test.mjs',
  'components/device-js/test/erf.test.mjs',
  'components/device-js/test/tanh.test.mjs',
  'components/device-js/test/warp.test.mjs',
  ...
  'components/cuda-library-adapters/test/public-cublaslt.test.mjs',
  'components/cuda-library-adapters/test/provider-profile.test.mjs',
  'conformance/f8/device-publication-oracle.test.mjs',
  'components/runtime-facade/test/runtime-facade.test.mjs',
  'components/runtime-facade/test/device-view-relation.test.mjs',
  'components/runtime-facade/test/compatibility-limit-projection.test.mjs',
