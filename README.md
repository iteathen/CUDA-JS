...
- **Linux-first reference platform.** Native Linux x86-64 is the reference implementation and primary qualification path; Ubuntu 24.04 LTS is the first exact evidence cell. Existing Windows x64 evidence remains valid as a secondary adapter/profile while Linux Driver/compiler adapters are completed. See [ADR-0006](docs/decisions/ADR-0006-linux-first-reference-platform.md).
