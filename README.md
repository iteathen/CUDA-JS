...
The package manifest is public rather than npm-private. The repository and installable source/tarball are public; a registry release still requires an owner-selected license and release review.
