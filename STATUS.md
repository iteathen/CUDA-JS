...
The generated [`docs/NODE_SUPPORT.md`](docs/NODE_SUPPORT.md) matrix records exact Node versions rather than semver ranges. Only Node 26.7.0 is qualified experimentally. Node 26.1.0 through 26.6.0 remain no-support even when the portable FFI/permission probe passes because their exact EXP-000 and native CUDA chains are absent. Node 26.0.0, Node 25.9.0, Node 24.19.0, and Node 22.23.2 are verified-negative probe rows because the required built-in FFI substrate is unavailable.
