...
Internal evidence can establish schema/frontend/package behavior for the exact tested revision. Hardware evidence can establish only the native operations, revision, Node/runtime, driver/toolchain, and hardware profile actually recorded.

## What it does not establish

It does not establish production support, general Linux qualification, universal Node-version compatibility, general performance superiority, or independent third-party reproduction.
